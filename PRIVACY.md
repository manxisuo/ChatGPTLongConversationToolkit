...
The extension only modifies the display of ChatGPT conversation history to improve usability. It does not upload conversation content, collect analytics, or store local conversation snapshots.
