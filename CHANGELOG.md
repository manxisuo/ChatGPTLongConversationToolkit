...
- Added an experimental in-page Conversation Tools panel prototype for Search, Outline, and Navigation
- Added an experimental local message extraction adapter with role, text, heading, code, image, and question markers
